...
- (void)viewDidLoad
{
    ...
    if (_refreshHeaderView == nil) {
        ...
        [[EGORefreshTableHeaderView alloc] initWithFrame:CGRectMake(0.0f, 10.0f-self.myTableView.bounds.size.height, self.myTableView.frame.size.width, self.view.bounds.size.height)];
        view1.delegate = self;
